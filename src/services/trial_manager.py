...
def process_trial(nct_id: str, folder: str = DEFAULT_OUTPUT_DIR) -> LogicalTrial:
    ...
    if logger.level <= logging.DEBUG:
        rich.print(identified_trial)  # Using rich.print for better readability in debug mode
    ...
    if logger.level <= logging.DEBUG:
        rich.print(logical_trial)  # Using rich.print for better readability in debug mode
