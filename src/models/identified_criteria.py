...
class RawTrialData(BaseModel):
    ...
    inclusion_criteria: str = Field(
        ..., description="inclusion criteria of the clinical trial."
    )
    exclusion_criteria: str = Field(
        ..., description="exclusion criteria of the clinical trial."
    )
    miscellaneous_criteria: str = Field(
        ..., description="miscellaneous criteria of the clinical trial."
    )
...
class LLMNumericalComparison(BaseModel):
    ...
    unit: str = Field(
        ...,
        description="The unit of the value being compared, if applicable, N/A otherwise.",
    )
...
class LLMRange(BaseModel):
    ...
    comparisons: list[LLMNumericalComparison] = Field(
        ..., description="List of comparison operations defining the range."
    )
...
class IdentifiedLine(BaseModel):
    ...
    criterions: List[LLMMultiRequirementCriterion] = Field(
