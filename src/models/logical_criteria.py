...
from src.models.identified_criteria import IdentifiedLine, RawTrialData, LLMMultiRequirementCriterion, Requirement
...
class IdentifiedUnrolledLine(BaseModel):
    ...
    criterions: List[SingleRequirementCriterion] = Field(..., description="List of structured criteria.")

class LLMLogicalAnd(BaseModel):
    """
    Represents a logical AND relationship between criteria.
    """
    and_criteria: List[Union[SingleRequirementCriterion, "LLMLogicalAnd", "LLMLogicalOr", "LLMLogicalNot","LLMLogicalXor", "LLMLogicalConditional" ]] = Field(..., description="The criteria involved in the relationship.")

class LLMLogicalOr(BaseModel):
    """
    Represents a logical OR relationship between criteria.
    """
    or_criteria: List[Union[SingleRequirementCriterion, "LLMLogicalAnd", "LLMLogicalOr", "LLMLogicalNot","LLMLogicalXor", "LLMLogicalConditional" ]] = Field(..., description="The criteria involved in the relationship.")
...
class LLMLogicalNot(BaseModel):
    ...
    """
    not_criteria: Union[SingleRequirementCriterion, "LLMLogicalAnd", "LLMLogicalOr", "LLMLogicalNot","LLMLogicalXor", "LLMLogicalConditional" ] = Field(..., description="The criteria involved in the relationship.")

class LLMLogicalXor(BaseModel):
    """
    Represents a logical XOR relationship between criteria.
    """
    xor_criteria: List[Union[SingleRequirementCriterion, "LLMLogicalAnd", "LLMLogicalOr", "LLMLogicalNot","LLMLogicalXor", "LLMLogicalConditional" ]] = Field(..., description="The criteria involved in the relationship.")
...
class LLMLogicalConditional(BaseModel):
    ...
    """
    condition: Union[SingleRequirementCriterion, "LLMLogicalAnd", "LLMLogicalOr", "LLMLogicalNot","LLMLogicalXor", "LLMLogicalConditional" ] = Field(..., description="The condition criterion (antecedent)")
    then_criteria: Union[SingleRequirementCriterion, "LLMLogicalAnd", "LLMLogicalOr", "LLMLogicalNot","LLMLogicalXor", "LLMLogicalConditional" , None] = Field(..., description="The criteria that apply if the condition (antecedent) is met. (consequent)")
    else_criteria: Union[SingleRequirementCriterion, "LLMLogicalAnd", "LLMLogicalOr", "LLMLogicalNot","LLMLogicalXor", "LLMLogicalConditional" , None] = Field(..., description="The criteria that apply if the condition (antecedent) is not met (optional consequent).")
...
class LogicalLine(BaseModel):
    ...
    """
    identified_line: IdentifiedUnrolledLine = Field(..., description="The identified line this was made from.")
    logical_structure: Union[SingleRequirementCriterion, LLMLogicalAnd, LLMLogicalOr, LLMLogicalNot, LLMLogicalXor, LLMLogicalConditional] = Field(..., description="The logically structured Criteria.")
