...
booleanParserTemplate = """Your objective is to reformat/parse pieces of text into a structured Boolean algebra representation suitable for a computer.
